...
function Register() {
  ...
  <p className="text-red-500 text-sm mt-1">{errors.username}</p>
        ...
        <button
          type="button"
          className="w-full bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium py-3 px-4 rounded-lg transition duration-200 flex items-center justify-center gap-2"
        >
